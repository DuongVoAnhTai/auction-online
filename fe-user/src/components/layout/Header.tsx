                ...
                <DropdownMenuContent className="w-80" align="end">
                  <DropdownMenuLabel className="flex items-center justify-between">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-auto p-1 text-xs text-primary hover:bg-transparent hover:underline"
                    ...
                    {notifications.length > 0 ? (
                      <div className="flex flex-col">
                        {notifications.map((notif) => (
                          ...
                          >
                            <p
                              className={`text-sm ${notif.isRead ? "font-normal" : "font-bold"}`}
                            >
                              {notif.title}
                            </p>
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem className="w-full text-center text-xs text-primary font-medium cursor-pointer">
